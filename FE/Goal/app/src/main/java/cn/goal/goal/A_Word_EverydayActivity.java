...
public class A_Word_EverydayActivity extends AppCompatActivity implements GetBitmapInterface {
    ...
    class FetchDataTask extends AsyncTask<Void, Void, DailySentence> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mLoadingDialog = new LoadingDialog().showLoading(A_Word_EverydayActivity.this);
        }
