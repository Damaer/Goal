...
import cn.goal.goal.Adapter.MyAdapterForContact;
...
public class ContactActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener,AdapterView.OnItemClickListener, MyAdapterForContact.Callback {
...
//        startActivity(intent);
    ...
    private void render(ArrayList<Message> messageArrayList) {
        ...
        MyAdapterForContact myadater=new MyAdapterForContact(this,messageArrayList,this);
