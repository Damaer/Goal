...
import cn.goal.goal.fragment.RealtimeStatisticsCountFragment;
import cn.goal.goal.fragment.RealtimeStatisticsRankingFragment;
import cn.goal.goal.fragment.RealtimeStatisticsStarsFragment;
import cn.goal.goal.adapter.RealtimeFragmentAdapter;
import cn.goal.goal.R;

public class RealtimeStatisticsActivity extends FragmentActivity implements OnPageChangeListener, OnClickListener
{
    ...
    private void initView() {
        ...
        RealtimeStatisticsStarsFragment myFragment1 = new RealtimeStatisticsStarsFragment();
        RealtimeStatisticsCountFragment myFragment2 = new RealtimeStatisticsCountFragment();
        RealtimeStatisticsRankingFragment myFragment3 = new RealtimeStatisticsRankingFragment();
        List<Fragment> fragmentList = new ArrayList<Fragment>();
        fragmentList.add(myFragment1);
        fragmentList.add(myFragment2);
        fragmentList.add(myFragment3);
        RealtimeFragmentAdapter myFragmentAdapter = new RealtimeFragmentAdapter(getSupportFragmentManager(), fragmentList);
