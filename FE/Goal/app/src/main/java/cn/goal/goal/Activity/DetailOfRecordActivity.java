...
import cn.goal.goal.Adapter.MyAdapterForEveryComment;
import cn.goal.goal.Adapter.MyAdapterForEveryRecord;
...
public class DetailOfRecordActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,AbsListView.OnScrollListener,MyAdapterForEveryComment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        record = MyAdapterForEveryRecord.list.get(getIntent().getExtras().getInt("commentIndex"));
    ...
    public void renderCommends(ArrayList<Comment> comments) {
        ...
        MyAdapterForEveryComment myadater=new MyAdapterForEveryComment(this,comments,this, record);
