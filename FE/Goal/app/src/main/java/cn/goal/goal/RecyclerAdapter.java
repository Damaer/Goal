...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public RecyclerAdapter(Context context, List<Testgoal> data) {
        this.data = data;
        inflater= (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
    public List<Testgoal>getdatalist()
    {
        return data;
    }
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            goaldate= (TextView) itemView.findViewById(R.id.goal_date);
            goaltype= (ImageView) itemView.findViewById(R.id.goal_type_image);
        }
    }
    /**
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(R.layout.listview_goal_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        //加载数据
        holder.goalname.setText(data.get(position).getGoalname());
        holder.goaldate.setText(data.get(position).getGoaldate());
        holder.goalimage.setImageResource(data.get(position).getGoalimage());
        holder.goaltype.setImageResource(data.get(position).getGoaltype());
    ...
    public interface OnItemClickListener{
        void onItemClick(int position,Testgoal model);
    }
}