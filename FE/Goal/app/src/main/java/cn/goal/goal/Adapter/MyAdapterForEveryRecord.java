...
public class MyAdapterForEveryRecord extends BaseAdapter implements View.OnClickListener{
    ...
    public MyAdapterForEveryRecord(Context context, ArrayList<Comment> data) {
        this.list = data;
        mContext = context;
    ...
    public View getView(final int position, View view2, ViewGroup parent) {
        ...
        list.get(position).getUser().setAvatarInterface(new GetBitmapListener(position) {
            ...
            public void getImg(Bitmap img) {
                ...
                MyAdapterForEveryRecord.this.notifyDataSetChanged();
            }
