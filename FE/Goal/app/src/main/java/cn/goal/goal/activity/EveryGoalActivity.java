...
import cn.goal.goal.utils.GoalRecordListView;
...
public class EveryGoalActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,AbsListView.OnScrollListener {
    ...
    private GoalRecordListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView= (GoalRecordListView)findViewById(R.id.every_record_listview);
  ...
  */
   ...
   @Override
    ...
    public void renderCommends(ArrayList<Comment> comments) {
        ...
        EveryRecordAdapter myadater=new EveryRecordAdapter(this,comments);
