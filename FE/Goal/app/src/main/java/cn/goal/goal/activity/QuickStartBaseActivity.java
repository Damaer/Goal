...
public abstract class QuickStartBaseActivity extends FragmentActivity {
    protected Context context;
    protected QuickStartBaseActivity activity;
...
//        }
    ...
    public void onStart() {
        ...
        //和removeActivity对应
        QuickStartManager.getInstance().addActivity(this);
    }
    ...
    public void onStop() {
        ...
        QuickStartManager.getInstance().removeActivity(this);
    }
    ...
    public interface LifeCycleListener {
        ...
        void onActivityCreated(QuickStartBaseActivity activity);

        void onActivityResumed(QuickStartBaseActivity activity);

        void onActivityStarted(QuickStartBaseActivity activity);

        void onActivityRestarted(QuickStartBaseActivity activity);

        void onActivityPaused(QuickStartBaseActivity activity);

        void onActivityStopped(QuickStartBaseActivity activity);

        void onActivityDestroyed(QuickStartBaseActivity activity);
