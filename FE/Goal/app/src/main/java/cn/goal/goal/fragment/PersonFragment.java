...
import cn.goal.goal.activity.AWordEverydayActivity;
import cn.goal.goal.activity.ContactActivity;
import cn.goal.goal.activity.EditInfoActivity;
import cn.goal.goal.R;
import cn.goal.goal.activity.RealtimeStatisticsActivity;
import cn.goal.goal.activity.SettingsActivity;
...
//        toolbar.setTitle(user.getUsername()); 此方法改变标题无效
    ...
    private void addListener() {
        ...
        dailySentence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 启动每日一句activity
                Intent intent = new Intent(getContext(), AWordEverydayActivity.class);
                startActivityForResult(intent, AWordEverydayActivity.REQUEST_CODE);
            }
        });
        ...
        statistics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 启动实时统计activity
                startActivity(new Intent(getContext(), RealtimeStatisticsActivity.class));
            }
        });
