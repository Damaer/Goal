...
public class EveryCommentAdapter extends BaseAdapter implements View.OnClickListener{
    ...
    public EveryCommentAdapter(Context context, ArrayList<Comment> data, Callback callback, Comment record) {
        this.record = record;
        this.list = data;
    ...
    public View getView(int position, View view2, ViewGroup parent) {
        ...
        user.setAvatarInterface(new GetBitmapListener(position) {
            ...
            public void getImg(Bitmap img) {
                ...
                EveryCommentAdapter.this.notifyDataSetChanged();
            }
