...
import cn.goal.goal.adapter.EveryCommentAdapter;
import cn.goal.goal.adapter.EveryRecordAdapter;
...
import cn.goal.goal.utils.GoalCommentListView;
import cn.goal.goal.utils.NetWorkUtils;
import cn.goal.goal.utils.Util;

import java.util.ArrayList;

public class DetailOfRecordActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,AbsListView.OnScrollListener,EveryCommentAdapter.Callback {
    private GoalCommentListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        record = EveryRecordAdapter.list.get(getIntent().getExtras().getInt("commentIndex"));
    ...
    public void renderCommends(ArrayList<Comment> comments) {
        ...
        listView= (GoalCommentListView) findViewById(R.id.listview_for_comment);
        EveryCommentAdapter myadater=new EveryCommentAdapter(this,comments,this, record);
